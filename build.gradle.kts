...
group = "lee.code.villagers"
version = "1.0.0"
description = "Villager NPC plugin."
...
tasks {
  ...
  shadowJar {
    ...
    // Relocate packages
    relocate("com.j256.ormlite", "lee.code.villagers.ormlite")
    relocate("me.lucko.commodore", "lee.code.villagers.commodore")
    relocate("me.lucko.commodore-file", "lee.code.villagers.commodore-file")
  }
}
